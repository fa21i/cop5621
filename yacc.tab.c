...
{
  "$end", "error", "$undefined", "CONST", "ID", "PLUS", "$accept", "prog",
  "op", "arg", YY_NULL
};
#endif
...
/* Line 1792 of yacc.c  */
#line 20 "yacc.y"
    {fprintf(fdot, "%d [label=prog ordering=\"out\"]\n%d [label=op ordering=\"out\"]\n", chars++,chars++);}
    break;
...
/* Line 1792 of yacc.c  */
#line 22 "yacc.y"
    {fprintf(fdot, "%d [label=op ordering=\"out\"]\n", chars++, (yyvsp[(1) - (3)].str)); 
